% given an arbitrary-order sword-topology matrix M, 
% transform it into the modified-shoelace topology.
% NOTE: the check for groups (Ms with zero-valued to-be-aligend vector) is not implemented.

function ret = sword_to_shoelace(M)
